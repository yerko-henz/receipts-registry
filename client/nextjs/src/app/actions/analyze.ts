...
function getLLMProvider(): LLMProvider {
  ...
  if (!apiKey) {
    throw new Error(
      `API key not set for provider: ${providerType}. Check NEXT_PUBLIC_${providerType.toUpperCase()}_API_KEY`,
    );
  }
  ...
  return {
    async analyzeReceipt(
      ...
      const userRegion =
        region || (await cookies()).get("NEXT_REGION")?.value || "en-US";
                ...
                schema: {
                  ...
                  properties: {
                      ...
                      items: {
                        ...
                        properties: {
                          ...
                          unitPrice: {
                            type: "string",
                            description:
                              "Exact string as on receipt, if available",
                          },
                        },
                    ...
                    taxAmount: {
                      type: "string",
                      description:
                        "Total tax/IVA amount as exact string from receipt",
                    },
                    discount: {
                      type: "string",
                      description:
                        "Total discount amount as exact string from receipt",
                    },
                    total: {
                      type: "string",
                      description:
      ...
      console.log(
        "Web OpenRouter Raw API Response:",
      ...
      const parsedData: ReceiptData = {
        ...
        taxAmount: rawData.taxAmount
          ? parseMonetaryValue(rawData.taxAmount, userRegion)
          : undefined,
        discount: rawData.discount
          ? parseMonetaryValue(rawData.discount, userRegion)
          : undefined,
      ...
      console.log(
        "Web OpenRouter Parsed Analysis Result:",

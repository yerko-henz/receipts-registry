            ...
            <CardContent className="p-0">
               <div className="p-8 space-y-8">
                  <div className="flex items-center justify-between border-b pb-6">
                      ...
                      <Button variant="outline" size="sm" onClick={() => setResult(null)}>{t('label')}</Button>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                      ...
                      <div className="space-y-1">
                          ...
                          <p className="text-2xl font-black text-primary">{result.total} {result.currency}</p>
                      </div>
                      <div className="space-y-1">
                ...
                >
                  ...
                  <div className="text-right flex flex-col items-end gap-1">
                    <span className="font-bold text-foreground">
                       {new Intl.NumberFormat('es-CL', { style: 'currency', currency: receipt.currency || 'CLP' }).format(receipt.total_amount || 0)}
                    </span>

...
const alertVariants = cva('relative w-full rounded-lg border p-4 [&>svg~*]:pl-7 [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg]:text-foreground', {
  variants: {
    variant: {
      ...
      destructive: 'border-red-500/80 text-red-700 bg-red-50 dark:bg-red-950/40 dark:border-red-500/60 dark:text-red-300 [&>svg]:text-red-600 dark:[&>svg]:text-red-400',
      success: 'border-green-500 text-green-700 dark:text-green-300 bg-green-50 dark:bg-green-950/40 dark:border-green-500/60 [&>svg]:text-green-600 dark:[&>svg]:text-green-400'
    }
  },
  defaultVariants: {
    variant: 'default'
